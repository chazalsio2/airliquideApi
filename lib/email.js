import { sendEmail, sendEmailWithTemplate , sendEmailWithTemplateFinalStep,sendEmailWithTemplateAnnonce } from "./mailjet";
...
export async function sendMandateSignatureConfirmation(client,com) {
  sendEmailWithTemplate({
    templateId: 1646869,
    variables: {
      firstname: client.firstname
    },
    CCemail: com ? com.email:null,
    email: client.email,
...
export async function sendAcceptPurchaseOfferConfirmation(client,com) {
  console.log(com);
  sendEmailWithTemplate({
    templateId: 1646933,
    variables: {
...
export async function sendAcceptSalesAgreementConfirmation(client,com) {
  sendEmailWithTemplate({
    templateId: 1647087,
    variables: {
      firstname: client.firstname
...
export async function sendAnbonceJSON(client,com) {
  sendEmailWithTemplateAnnonce({
    templateId: 1647087,
    variables: {
      firstname: client.firstname
    },
...
export async function sendAcceptLoanOfferConfirmation(client,com) {
  sendEmailWithTemplate({
    templateId: 1647135,
    variables: {
      firstname: client.firstname
...
export async function sendMandateSignedForSalesProject(client,com) {
  sendEmailWithTemplate({
    templateId: 1770124,
    variables: {
      firstname: client.firstname
...
export async function sendPurchaseOfferAcceptedForSalesProject(client,com) {
  sendEmailWithTemplate({
    templateId: 1770126,
    variables: {
      firstname: client.firstname
...
export async function sendSalesAgreementAcceptedForSalesProject(client,com) {
  sendEmailWithTemplate({
    templateId: 1770128,
    variables: {
      firstname: client.firstname
...
export async function sendLoanOfferAcceptedForSalesProject(client,com) {
  sendEmailWithTemplate({
    templateId: 1770129,
    variables: {
      firstname: client.firstname
...
export async function sendDeedAcceptedForSalesProject(client,com) {
  sendEmailWithTemplate({
    templateId: 1770130,
    variables: {
      firstname: client.firstname
