...
class DocusignManager {
  ...
  init() {
    console.log("Initialisation de docusign");
  }
  ...
  sendEnvelope() {
    ...
    envDef.templateId = "28bb5c99-3f61-4eed-a5be-bef90c2bcff1";
    var tRole = new docusign.TemplateRole();
    tRole.email = "payet.fab+client@gmail.com";
    tRole.name = "Fabrice Payet";
